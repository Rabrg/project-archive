...
public final class TeleportDuelArenaNode extends Node {
	...
	public boolean validate() {
		return ctx.getInventory().isFull() && smallPouch && mediumPouch && CASTLE_WARS_AREA.contains(ctx.getLocalPlayer()) && (ring = ctx.getEquipment().getItemInSlot(EquipmentSlot.RING.getSlot())) != null;
	}
	...
	public int execute() {
		if (ctx.getTabs().getOpen() != Tab.EQUIPMENT) {
			...
			return Calculations.random(3600, 4200);
		}
