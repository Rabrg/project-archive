...
@ScriptManifest(author="Rabrg", category= Category.COMBAT, name="Rabrg Combat", version=0.9, description="Kills things")
public final class RabrgCombat extends AbstractScript {
	...
	public void onMessage(final Message message) {
		if (message.getMessage().contains("I'm already under attack."))
			sleep(1200, 1600);
		else if (message.getMessage().contains("Nieve wants"))
			getTabs().logout();
	}
