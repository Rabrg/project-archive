...
public abstract class SpiralTask implements Runnable {
	...
	public SpiralTask(final CLocation fLocation, final int radius) {
	...
	/*
	 * Returns an CLocation pointing at the current chunk X and Z values.
	 */
	public final CLocation currentCLocation() {
		return new CLocation(world.getName(), x, z);
	}
	...
	public final Location currentLocation() {
		return new Location(world, CLocation.chunkToBlock(x), 65.0, CLocation.chunkToBlock(z));
	}
