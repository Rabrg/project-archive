...
public class ScaledSGDMinimizer<Q extends AbstractStochasticCachingDiffFunction> extends StochasticMinimizer<Q> {
  ...
  private void updateDiagMinErr(double[] diag,double[] s,double[] y){
    ...
    edu.stanford.nlp.optimization.Function<Double,Double> func = new lagrange(s,y,diag,alpha);
  ...
  private double getRoot(edu.stanford.nlp.optimization.Function<Double,Double> func, double lower, double upper){
  ...
  static class lagrange implements edu.stanford.nlp.optimization.Function<Double,Double> {
    double[] s;
    double[] y;
    double[] d;
    double a;
