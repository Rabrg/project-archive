...
public class Conf {
	...
	public static double powerOfflineLossLimit = 0.0; // players will no longer
														...
														// power drops to this
														// amount or less
	public static double powerClanMax = 0.0; // if greater than 0, the cap on
												// how much power a clan can
	...
	public static int clanTagLengthMin = 3;
	public static int clanTagLengthMax = 10;
	public static boolean clanTagForceUpperCase = false;

	public static boolean newClansDefaultOpen = false;

	// when clan membership hits this limit, players will no longer be able to
	// join using /c join; default is 0, no limit
	public static int clanMemberLimit = 0;

	// what clan ID to start new players in when they first join the server;
	// default is 0, "no clan"
	public static String newPlayerStartingClanID = "0";

	public static boolean showMapClanKey = true;
	public static boolean showNeutralClansOnMap = true;
	public static boolean showEnemyClansOnMap = true;

	// Disallow joining/leaving/kicking while power is negative
	public static boolean canLeaveWithNegativePower = true;

	// Configuration for clan-only chat
	public static boolean clanOnlyChat = true;
	// Configuration on the Clan tag in chat messages.
	...
	public static String clanChatFormat = "%s:" + ChatColor.WHITE + " %s";
	...
	public static boolean logClanCreate = true;
	public static boolean logClanDisband = true;
	public static boolean logClanJoin = true;
	public static boolean logClanKick = true;
	public static boolean logClanLeave = true;
	...
	public static boolean disablePVPBetweenNeutralClans = false;
	public static boolean disablePVPForClanlessPlayers = false;
	public static boolean enablePVPAgainstClanlessInAttackersLand = false;
	...
	public static boolean permanentClansDisableLeaderPromotion = false;

	public static boolean claimsMustBeConnected = false;
	public static boolean claimsCanBeUnconnectedIfOwnedByOtherClan = true;
	public static int claimsRequireMinClanMembers = 1;
	...
	public static double considerClansReallyOfflineAfterXMinutes = 0.0;

	public static int actionDeniedPainAmount = 1;

	// commands which will be prevented if the player is a member of a permanent
	// clan
	public static Set<String> permanentClanMemberDenyCommands = new LinkedHashSet<String>();
	...
	// for claimed areas where further clan-member ownership can be defined
	public static boolean ownedAreasEnabled = true;
	public static int ownedAreasLimitPerClan = 0;
	...
	public static String publicLandMessage = "Public clan land.";
	...
	// Spout features
	public static boolean spoutClanTagsOverNames = true; // show clan tags over
															// names over player
															// heads
	public static boolean spoutClanTitlesOverNames = true; // whether to include
															// player's title in
															// that
	public static boolean spoutClanAdminCapes = true; // Show capes on clan
														// admins, colored based
														// on the viewer's
														// relation to the
														// target player
	public static boolean spoutClanModeratorCapes = true; // same, but for clan
															// moderators
	...
	public static float spoutTerritoryNoticeLeaveAfterSeconds = 2.00f; // how
																		...
																		// goes
																		// away
	public static String capeAlly = "https://github.com/MassiveCraft/Clans/raw/master/capes/ally.png";
	public static String capeEnemy = "https://github.com/MassiveCraft/Clans/raw/master/capes/enemy.png";
	public static String capeMember = "https://github.com/MassiveCraft/Clans/raw/master/capes/member.png";
	public static String capeNeutral = "https://github.com/MassiveCraft/Clans/raw/master/capes/neutral.png";
	public static String capePeaceful = "https://github.com/MassiveCraft/Clans/raw/master/capes/peaceful.png";

	// Economy settings
	public static boolean econEnabled = false;
	public static String econUniverseAccount = "";
	public static double econCostClaimWilderness = 30.0;
	public static double econCostClaimFromClanBonus = 30.0;
	...
	// Clan banks, to pay for land claiming and other costs instead of
	...
	public static boolean bankMembersCanWithdraw = false; // Have to be at least
															...
															// money to another
															// clan
	public static boolean bankClanPaysCosts = true; // The clan pays for clan
													// command costs, such as
													// sethome
	public static boolean bankClanPaysLandCosts = true; // The clan pays for
														// land claiming costs.
