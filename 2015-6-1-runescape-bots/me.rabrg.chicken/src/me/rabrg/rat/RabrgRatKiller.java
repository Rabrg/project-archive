...
@ScriptManifest(author="Rabrg", category= Category.COMBAT, name="Chicken killer", version=0.3, description="Kills goblins")
public final class RabrgRatKiller extends AbstractScript {
	...
	@Override
	public int onLoop() {
		arrows = getEquipment().getItemInSlot(EquipmentSlot.ARROWS.getSlot());
		if (arrows != null && arrows.getAmount() < 100) {
			getTabs().logout();
		}
