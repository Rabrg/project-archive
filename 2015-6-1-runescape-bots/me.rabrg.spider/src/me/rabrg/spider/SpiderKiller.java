...
import me.rabrg.spider.node.AttackNode;
import me.rabrg.spider.node.EatNode;
import me.rabrg.spider.node.Node;

@ScriptManifest(author="Rabrg", category= Category.COMBAT, name="Spider Killer", version=0.9, description="Kills spiders")
public final class SpiderKiller extends AbstractScript {
