...
public final class Ratings {
	...
	public void adjustRatings(final Player winner, final Player loser) {
		ratings.set(winner.getName(), RatingCalculator.getNewRating(getRating(winner), getRating(loser), true));
		ratings.set(loser.getName(), RatingCalculator.getNewRating(getRating(winner), getRating(loser), false));
	}
}
