...
import me.rabrg.clans.zcore.persist.SaveTask;
import me.rabrg.clans.zcore.util.LibLoader;
import me.rabrg.clans.zcore.util.PermUtil;
import me.rabrg.clans.zcore.util.Persist;
...
public abstract class MPlugin extends JavaPlugin {
	...
	public boolean preEnable() {
		...
		if (saveTask == null && Conf.saveToFileEveryXMinutes > 0.0) {
			final long saveTicks = (long) (20 * 60 * Conf.saveToFileEveryXMinutes); // Approximately
																					// every
																					// 30
																					// min
																					// by
