...
/**
 * Implements a file filter that filters based on a passed in {@link Pattern}.
 * Preciesly, it will accept exactly those {@link File}s for which
...
public class RegExFileFilter implements FileFilter {
   ...
   * entire path) matches the passed in {@link Pattern}.
   */
