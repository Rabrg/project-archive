...
public class GoldenSectionLineSearch implements LineSearcher {
  ...
  public double minimize(edu.stanford.nlp.optimization.Function<Double, Double> function, double tol, double low, double high) {
    this.tol = tol;
    this.low = low;
    this.high = high;
  ...
  public double minimize(edu.stanford.nlp.optimization.Function<Double, Double> function) {
  ...
  public void discretizeCompute(edu.stanford.nlp.optimization.Function<Double, Double> function, int numPoints, double low, double high) {
  ...
  public static void main(String[] args) {
    ...
    edu.stanford.nlp.optimization.Function<Double, Double> f1 = new edu.stanford.nlp.optimization.Function<Double, Double>() {
    ...
    edu.stanford.nlp.optimization.Function<Double,Double> f2 = new edu.stanford.nlp.optimization.Function<Double,Double>() {
       public Double apply(Double x) {
