...
public final class WalkMageNode extends Node {
	...
	public int execute() {
                ...
                if(dangerousPlayers > 0) {
                    ...
                    Game.instaHop(new Filter<WorldData>() {
						@Override
						public boolean accept(WorldData data) {
							return data.isMembers() && !data.isPvP() && data.getID() != 353 && data.getID() != 361 && data.getID() != 366 && data.getID() != 373;
						}
                    });
